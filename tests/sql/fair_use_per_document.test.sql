...
BEGIN
  ...
  SELECT * INTO r FROM public.fair_use_consume_for_document(v_user, v_doc, '2026-09', 'aiDocuments', 50);
  ...
  SELECT * INTO r FROM public.fair_use_consume_for_document(v_user, v_doc, '2026-10', 'aiDocuments', 50);
  ...
  SELECT * INTO r FROM public.fair_use_consume_for_document(v_user, v_doc2, '2026-09', 'aiDocuments', 50);
  ...
  SELECT * INTO r FROM public.fair_use_release_for_document(v_user, v_doc, 'aiDocuments');
  ...
  BEGIN
    SELECT * INTO r FROM public.fair_use_consume_for_document(v_other, v_doc, '2026-09', 'aiDocuments', 50);
